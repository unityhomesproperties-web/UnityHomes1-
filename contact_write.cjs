...
const content = `import React, { useState, FormEvent } from 'react';
...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="relative text-white pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-[#2F8D46]">
